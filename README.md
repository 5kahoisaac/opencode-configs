...
|:-----------------------|:--------------------|:-------------------------------|:-------------------------------|:---------|:-------------------------------------------------------------------------------------------------------|
| **oh-my-opencode**     | `sisyphus`          | Orchestrator                   | `kimi-for-coding/k2p5`         | -        | Primary orchestrator for complex, multi-step tasks and agent coordination                              |
| **oh-my-opencode**     | `hephaestus`        | Implementation Specialist      | `zai-coding-plan/glm-5`        | `medium` | Executes implementation tasks with balanced capability and efficiency                                  |
| **oh-my-opencode**     | `oracle`            | Strategic Advisor              | `zai-coding-plan/glm-5`        | `high`   | Provides high-level architectural guidance and complex reasoning for critical decisions                |
| **oh-my-opencode**     | `librarian`         | Research Specialist            | `opencode/gemini-3-flash`      | `low`    | Handles documentation lookup, external research, and information retrieval tasks                       |
| **oh-my-opencode**     | `explore`           | Codebase Analysis              | `xai/grok-code-fast-1`         | `medium` | Performs rapid codebase navigation, pattern detection, and symbol exploration                          |
| **oh-my-opencode**     | `multimodal-looker` | Visual Analysis                | `kimi-for-coding/k2p5`         | -        | Analyzes visual content, images, and multimodal inputs for comprehensive understanding                 |
| **oh-my-opencode**     | `prometheus`        | Planning Specialist            | `kimi-for-coding/k2p5`         | -        | Creates detailed plans and work breakdowns for complex projects and feature implementations            |
| **oh-my-opencode**     | `metis`             | Scope Analysis                 | `kimi-for-coding/k2p5`         | -        | Analyzes task scope, identifies ambiguities, and provides pre-planning consultation                    |
| **oh-my-opencode**     | `momus`             | Quality Review                 | `zai-coding-plan/glm-4.7`      | `high`   | Reviews work plans and implementations for quality, completeness, and adherence to best practices      |
| **oh-my-opencode**     | `atlas`             | Knowledge Specialist           | `kimi-for-coding/k2p5`         | -        | Manages and retrieves contextual knowledge, architectural decisions, and project conventions           |
...
|:--------------------|:-------------------------------|:---------------------------------------------------------|
| `visual-engineering`| `xai/grok-4-1-fast-reasoning`  | Frontend, UI/UX, design, styling, and animation tasks    |
| `ultrabrain`        | `zai-coding-plan/glm-5`        | Hard logic-heavy tasks requiring deep reasoning          |
| `quick`             | `zai-coding-plan/glm-4.7`      | Trivial tasks, single file changes, typo fixes           |
| `unspecified-low`   | `zai-coding-plan/glm-4.6`      | Low-effort tasks that don't fit other categories         |
| `unspecified-high`  | `zai-coding-plan/glm-4.7`      | High-effort tasks that don't fit other categories        |
| `writing`           | `kimi-for-coding/k2p5`         | Documentation, prose, and technical writing tasks        |
